...
namespace Pb503MiniProject.Migrations
{
    ...
    [Migration("20250201141604_Pb503MiniProject")]
    partial class Pb503MiniProject
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthorBook", b =>
                {
                    b.HasOne("Pb503MiniProject.Models.Author", null)
                        .WithMany()
                        .HasForeignKey("AuthorsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Pb503MiniProject.Models.Book", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Pb503MiniProject.Models.Loan", b =>
                {
                    b.HasOne("Pb503MiniProject.Models.Borrower", "Borrowers")
                        .WithMany("Loans")
            ...
            modelBuilder.Entity("Pb503MiniProject.Models.LoanItem", b =>
                {
                    b.HasOne("Pb503MiniProject.Models.Book", "Books")
                        .WithMany()
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Pb503MiniProject.Models.Loan", "Loans")
                        .WithMany("LoanItems")
